...
const MobileFooter = () => {
  ...
  return (
    <footer style={{ borderTop: '1px solid' }} className="transition-colors dark:bg-dark dark:text-gray sticky w-full text-lightGray pb-2 pt-2 mt-4 pl-6 pr-6 bottom-0 bg-white lg:hidden">
