...
const VideoUpload = ({ channelId, channelName }) => {
  ...
  const defaultPoster: string = "https://firebasestorage.googleapis.com/v0/b/fir-fc298.appspot.com/o/posters%2Fdefault(1).webp?alt=media&token=72d58d6b-0968-4071-ae3a-cbb8bef5631b";
  ...
  const handleUpload = () => {
    ...
    if (videoFile) {
      setLoading(true);
      if (posterFile.current.files.length > 0) { // if a poster file exist
