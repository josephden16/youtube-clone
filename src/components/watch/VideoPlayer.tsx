...
export default function VideoPlayer({ data, channelData, nextVideoId, autoplay, loading, setVideoData, setChannelData, videoOptions, videoId }) {
  ...
  return (
    <div>
      ...
      <div className="transition-colors dark:border-gray ml-4 mr-4 mt-3 mb-9 pb-3 border-lightGray border-b-1">
        ...
        <button onClick={toggleDescription} style={{ outline: 'none' }} className="dark:text-lightGray mt-2 uppercase text-gray text-sm font-bold">
